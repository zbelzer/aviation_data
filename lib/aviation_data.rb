module AviationData
  ...
  HEADERS = {
    ...
    'ACFTREF'  => %w(code manufacturer_name model_name aircraft_type engine_type aircraft_category_code builder_certification_code engines seats weight cruising_speed),
